    ...
    <section className="mt-4">
      <div>
        <div
          ...
          style={{
            backgroundImage: `url(${bg_container})`,
            backgroundSize: "cover",
            backgroundPosition: "center",
          }}
        >
          <div className="container mx-auto px-4">
            <h1 className="text-3xl md:text-[72px] font-bold text-center main_header">
              Welcome to the <br />
            ...
            <h2 className="text-center text-lg md:text-2xl tracking-wide">
